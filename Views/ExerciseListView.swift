...
#Preview {
    ExerciseListView(exercises:.constant([Exercise(bodyPart: "shoulders", equipment: "band", gifUrl: "https://v2.exercisedb.io/image/whon-vU7j3m08S", id: "0977", name: "band front lateral raise", target: "delts", secondaryMuscles: [
        "traps",
        "upper back"
      ], instructions: [
